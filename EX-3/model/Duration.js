/**
 * Represents an immutable duration of time in seconds.
 */
class Duration {
  /**
  ...
  /**
   * Creates a Duration from a plain object (used when loading from JSON).
   * @param {object} obj - Object with _totalSeconds property.
   * @returns {Duration}
   */
  static fromObject(obj) {
    return new Duration(obj._totalSeconds);
  }
